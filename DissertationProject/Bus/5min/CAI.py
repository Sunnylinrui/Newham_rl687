...
INPUT_PATH  = r"/Users/starry/Documents/GIS/Applied Project(Academic)/Picture1/5CAIBus.csv"
LSOA_COL    = "LSOA21CD"
CAI_COL     = "CAI"
OUT_PREFIX  = "bus_cai_newham"
...
def main():
    ...
    ax.set_title("5-Minute Bus Stop Accessibility CAI Class Shares (Newham)")
    ...
    ax.set_ylabel("CAI")
    ax.set_title("Bus CAI by LSOA (sorted)")
