...
# Read CSV files
df = pd.read_csv("/Users/starry/Documents/GIS/Applied Project(Academic)/Picture1/10 min Stations Accessibility Index No Car.csv")
...
print(f"Pearson correlation coefficient: {corr:.3f}, p: {p_value:.5f}")
