...
y = df["Index of Multiple Deprivation (IMD) Score"]

# Delete missing values
data = pd.DataFrame({"Accessibility Index": x, "IMD Score": y}).dropna()
x_clean = data["Accessibility Index"]
y_clean = data["IMD Score"]
...
plt.title("Relationship Between Accessibility Index and IMD Score")
plt.grid(True)
plt.tight_layout()
plt.show()
