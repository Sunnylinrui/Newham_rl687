...
y = df["Education Score"]

# Delete missing values
data = pd.DataFrame({"Accessibility Index": x, "Education Score": y}).dropna()
x_clean = data["Accessibility Index"]
y_clean = data["Education Score"]
...
plt.title("Relationship Between Accessibility Index and Education Score")
plt.grid(True)
plt.tight_layout()
plt.show()
